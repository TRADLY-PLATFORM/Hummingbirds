...
module.exports  = {
    base: 'https://api.tradly.app', // base url of the website
    urls: [
        'https://api.tradly.app' // URLs to scan (works only if autoCrawl is false)
    ],
    strictPresence: 'https://api.tradly.app/', // Crawl links only if this is present
