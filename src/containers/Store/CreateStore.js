                    ...
                    <div className="col-lg-12">                        
                        <nav aria-label="breadcrumb">
                            <ol className={classes.breadCrumb}>
                                <li className="breadcrumb-item active" aria-current="page"><Link to="/store"><img src={ArrowLogo} alt="store" style={{marginRight: '10px'}}/>Back to my store</Link></li>
                            </ol>
                        </nav>
                    </div>
                        ...
                        <div className="row">
                            ...
                            <div className={classes.addgroup}>
                                <div className="form-group mt-2 ">
                                    <input className={classes.input + " form-control input-lg "} name="name" value={this.state.name} onChange={this.handleChange} type="text" placeholder="Store Name"/>
                                </div>
                                ...
                                <div className="form-group mt-2">
                                    <input className={classes.input + " form-control input-lg "} name="description" value={this.state.description} onChange={this.handleChange} type="text" placeholder="Store Description"/>
                                </div>                    
                            </div>
                            ...
                            <div className="text-center" style={{paddingBottom:'3em',paddingTop:'1em'}}>
                                <button className="btnGreenStyle" onClick={this.createStore}>Create Store</button>
                            </div>
