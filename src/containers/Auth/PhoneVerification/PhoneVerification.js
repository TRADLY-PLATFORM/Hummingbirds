            ...
            <div className="row text-center mt-5">
                ...
                <div className="col-lg-12 nopaddingLeft">
                    ...
                    <div className="row text-center mt-4">
                        <div >
                            <input type="text" className={ classes.PhoneDigit + " form-control" } maxLength="6"  value={this.state.verificationCode} name="verificationCode" onChange={this.handleChange}/>
