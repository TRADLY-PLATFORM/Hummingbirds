...
const productReducer = ( state = initialState, action) =>{
    switch(action.type){
        ...
        case actionTypes.SET_CATEGORY_LISTS: return setCategoryLists(state, action);
        case actionTypes.FETCH_CATEGORY_LISTS_FAILED: return fetchCategoryListsFailed(state, action);
        case actionTypes.INIT_CATEGORY_LISTS: return startCategoryLists(state, action);
        default:
            return state;
    }
}
